...
defmodule AriaHybridPlanner do
  ...
  @doc """
  Re-plans from a failure node in the planner's solution tree.
  ...
  ## Examples
      ...
      iex> # Assume node 5 failed during execution
      iex> {:ok, recovery_plan} = AriaHybridPlanner.replan(state, 5, domain, todos)
  """
